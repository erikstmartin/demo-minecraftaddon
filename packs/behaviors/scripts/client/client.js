...
clientSystem.initialize = function () {
	...
	clientSystem.registerEventData("erik:pinky", eventDataDefaults)
...
clientSystem.update = function() {
	...
	if (firstTick) {
		...
		let pinkyEventData = clientSystem.createEventData("erik:pinky");
		pinkyEventData.data.narf = true;

		clientSystem.broadcastEvent("erik:pinky", pinkyEventData);
	}
}
